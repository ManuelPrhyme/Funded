...
const Navbar: React.FC = () => {
  ...
  const { account, connectWallet, isConnecting, chainId, switchToSepolia } = useWallet();
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <div className="relative flex items-center">
              <input
                ...
                className="py-1 pl-10 pr-4 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-64"
              />
